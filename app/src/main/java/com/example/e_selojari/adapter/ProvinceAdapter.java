package com.example.e_selojari.adapter;
...
import com.example.e_selojari.R;
...
public class ProvinceAdapter extends BaseAdapter {
     ...
     */
    public ProvinceAdapter(Activity activity, List<com.example.e_selojari.model.province.Result> movieItems) {
        this.activity = activity;
        this.movieItems = movieItems;

        listlokasiasli = new ArrayList<com.example.e_selojari.model.province.Result>();
    ...
    public void setList(List<com.example.e_selojari.model.province.Result> movieItems){
